...
insert into car(id,model,color,driver_id,year_column) values(1,'ford','black',1,2015);
insert into car(id,model,color,driver_id,year_column) values(2,'vw','white',2,2016);
